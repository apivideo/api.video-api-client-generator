...
public class AdvancedAuthenticationApiTest extends AbstractApiTest {
    ...
    class authenticate {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat().contains("Missing the required parameter 'authenticatePayload' when calling authenticate");
        ...
        public void responseWithStatus400Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class, () -> api.authenticate(new AuthenticatePayload().apiKey("invalid")));
    ...
    class refresh {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat().contains("Missing the required parameter 'refreshTokenPayload' when calling refresh");
        ...
        public void responseWithStatus400Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class, () -> api.refresh(new RefreshTokenPayload().refreshToken("token")));
            assertThat(e.getCode()).isEqualTo(400);
            assertThat(e).hasMessageThat().contains("The user credentials were incorrect.");
        }
    }
